			...
			<div className='container mx-auto'>
				<div className='grid grid-cols-12'>
					<div className='lg:flex hidden justify-center col-span-2'>
						...
						: <Link href='/'><button className='hover:text-orange-500 hover:bg-white text-white border-2 border-orange-500 rounded-lg bg-orange-500 px-5 py-2 duration-150' onClick={logout}>خروج</button></Link>}
					</div>
