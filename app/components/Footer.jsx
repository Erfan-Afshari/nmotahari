...
import { lalezar, Vazir } from '@/app/utils/fonts'
		...
		<div class={`${Vazir.className} ${"container py-8 mx-auto"}`}>
			...
			<div class="grid grid-cols-12 md:gap-12">
				...
				<div className='md:col-span-4 col-span-12 pt-4'>
					<div>
						<h1 className={`${lalezar.className} ${'flex text-white text-2xl mb-2'}`}><HiOutlineLocationMarker className='text-white text-3xl' /> نشانی:</h1>
			...
			<div className='mt-6'>
				<div>
					<h1 className={`${lalezar.className} ${'text-white text-2xl mb-2'}`}>ما را در فضای مجازی دنبال کنید</h1>
				</div>
